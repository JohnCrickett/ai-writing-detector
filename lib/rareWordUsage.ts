...
const COMMON_WORDS = new Set([
  ...
  // Common everyday verbs and their forms
  'access', 'accessed', 'accessing', 'achieve', 'achieved', 'achieving',
  'act', 'acted', 'acting', 'add', 'added', 'adding', 'admit', 'admitted',
  'affect', 'affected', 'affecting', 'agree', 'agreed', 'agreeing',
  'allow', 'allowed', 'allowing', 'announce', 'announced', 'announcing',
  'apply', 'applied', 'applying', 'applies', 'approve', 'approved', 'approving',
  'arrange', 'arranged', 'arranging', 'assume', 'assumed', 'assuming',
  'avoid', 'avoided', 'avoiding', 'blame', 'blamed', 'blaming',
  'block', 'blocked', 'blocking', 'bother', 'bothered', 'bothering',
  'cause', 'caused', 'causing', 'change', 'changed', 'changing', 'changes',
  'charge', 'charged', 'charging', 'check', 'checked', 'checking',
  'choose', 'chose', 'chosen', 'choosing', 'claim', 'claimed', 'claiming',
  'compare', 'compared', 'comparing', 'consider', 'considered', 'considering',
  'contain', 'contained', 'containing', 'control', 'controlled', 'controlling',
  'cover', 'covered', 'covering', 'create', 'created', 'creating',
  'deal', 'dealt', 'dealing', 'decide', 'decided', 'deciding',
  'deliver', 'delivered', 'delivering', 'demand', 'demanded', 'demanding',
  'depend', 'depended', 'depending', 'depends', 'deploy', 'deployed', 'deploying',
  'describe', 'described', 'describing', 'develop', 'developed', 'developing',
  'discuss', 'discussed', 'discussing', 'discover', 'discovered', 'discovering',
  'doubt', 'doubted', 'doubting', 'drop', 'dropped', 'dropping',
  'earn', 'earned', 'earning', 'enable', 'enabled', 'enabling',
  'enjoy', 'enjoyed', 'enjoying', 'enter', 'entered', 'entering',
  'establish', 'established', 'establishing', 'examine', 'examined', 'examining',
  'exist', 'existed', 'existing', 'exists', 'expect', 'expected', 'expecting',
  'explain', 'explained', 'explaining', 'express', 'expressed', 'expressing',
  'extend', 'extended', 'extending', 'face', 'faced', 'facing',
  'fail', 'failed', 'failing', 'fill', 'filled', 'filling',
  'finish', 'finished', 'finishing', 'follow', 'followed', 'following',
  'force', 'forced', 'forcing', 'forget', 'forgot', 'forgotten',
  'form', 'formed', 'forming', 'gain', 'gained', 'gaining',
  'gather', 'gathered', 'gathering', 'handle', 'handled', 'handling',
  'happen', 'happened', 'happening', 'imagine', 'imagined', 'imagining',
  'improve', 'improved', 'improving', 'increase', 'increased', 'increasing',
  'indicate', 'indicated', 'indicating', 'inform', 'informed', 'informing',
  'intend', 'intended', 'intending', 'introduce', 'introduced', 'introducing',
  'involve', 'involved', 'involving', 'join', 'joined', 'joining',
  'lack', 'lacked', 'lacking', 'lead', 'led', 'leading',
  'limit', 'limited', 'limiting', 'manage', 'managed', 'managing',
  'mark', 'marked', 'marking', 'matter', 'mattered', 'mattering',
  'measure', 'measured', 'measuring', 'mention', 'mentioned', 'mentioning',
  'miss', 'missed', 'missing', 'note', 'noted', 'noting',
  'notice', 'noticed', 'noticing', 'obtain', 'obtained', 'obtaining',
  'occur', 'occurred', 'occurring', 'offer', 'offered', 'offering',
  'operate', 'operated', 'operating', 'organize', 'organized', 'organizing',
  'pass', 'passed', 'passing', 'perform', 'performed', 'performing',
  'permit', 'permitted', 'permitting', 'place', 'placed', 'placing',
  'point', 'pointed', 'pointing', 'prefer', 'preferred', 'preferring',
  'present', 'presented', 'presenting', 'prevent', 'prevented', 'preventing',
  'produce', 'produced', 'producing', 'promise', 'promised', 'promising',
  'protect', 'protected', 'protecting', 'prove', 'proved', 'proving',
  'provide', 'provided', 'providing', 'publish', 'published', 'publishing',
  'raise', 'raised', 'raising', 'reach', 'reached', 'reaching',
  'realize', 'realized', 'realizing', 'recognize', 'recognized', 'recognizing',
  'record', 'recorded', 'recording', 'reduce', 'reduced', 'reducing',
  'refer', 'referred', 'referring', 'reflect', 'reflected', 'reflecting',
  'refuse', 'refused', 'refusing', 'regard', 'regarded', 'regarding',
  'relate', 'related', 'relating', 'release', 'released', 'releasing',
  'remain', 'remained', 'remaining', 'remember', 'remembered', 'remembering',
  'remove', 'removed', 'removing', 'repeat', 'repeated', 'repeating',
  'replace', 'replaced', 'replacing', 'report', 'reported', 'reporting',
  'represent', 'represented', 'representing', 'require', 'required', 'requiring',
  'respond', 'responded', 'responding', 'result', 'resulted', 'resulting',
  'return', 'returned', 'returning', 'reveal', 'revealed', 'revealing',
  'review', 'reviewed', 'reviewing', 'save', 'saved', 'saving',
  'search', 'searched', 'searching', 'seek', 'sought', 'seeking',
  'share', 'shared', 'sharing', 'sign', 'signed', 'signing',
  'spend', 'spent', 'spending', 'spread', 'spreading',
  'suggest', 'suggested', 'suggesting', 'suppose', 'supposed', 'supposing',
  'survive', 'survived', 'surviving', 'tend', 'tended', 'tending',
  'treat', 'treated', 'treating', 'trust', 'trusted', 'trusting',
  'understand', 'understood', 'understanding', 'visit', 'visited', 'visiting',
  'wait', 'waited', 'waiting', 'warn', 'warned', 'warning',
  'wish', 'wished', 'wishing', 'wonder', 'wondered', 'wondering',

  // Common everyday nouns
  'access', 'account', 'action', 'activity', 'addition', 'address',
  'adoption', 'advantage', 'advice', 'age', 'agency', 'agent',
  'aim', 'amount', 'analysis', 'answer', 'appearance', 'application',
  'approach', 'approval', 'argument', 'army', 'aspect', 'attention',
  'authority', 'base', 'basis', 'benefit', 'bit', 'board', 'bottom',
  'box', 'brain', 'breath', 'brother', 'budget', 'business',
  'call', 'campaign', 'capital', 'career', 'cause', 'center', 'centre',
  'century', 'chance', 'chapter', 'charge', 'choice', 'church',
  'claim', 'client', 'club', 'code', 'collection', 'college',
  'commission', 'committee', 'community', 'company', 'condition',
  'conference', 'congress', 'connection', 'content', 'conversation',
  'corner', 'council', 'couple', 'court', 'crisis', 'crowd',
  'cup', 'customer', 'cut', 'data', 'daughter', 'deal', 'debate',
  'decision', 'degree', 'demand', 'department', 'description', 'detail',
  'development', 'device', 'difference', 'difficulty', 'direction',
  'discussion', 'door', 'drive', 'drug', 'duty', 'economy', 'edge',
  'editor', 'education', 'effect', 'effort', 'election', 'employee',
  'employer', 'employment', 'engineering', 'environment', 'equipment',
  'era', 'estate', 'event', 'evidence', 'example', 'exchange',
  'experience', 'expert', 'expression', 'extent', 'eye',
  'failure', 'farm', 'feature', 'feeling', 'figure', 'file', 'finger',
  'floor', 'focus', 'food', 'foot', 'forest', 'front',
  'fund', 'gap', 'goal', 'goods', 'ground', 'growth', 'guard',
  'guess', 'guide', 'gun', 'hair', 'hall', 'hand', 'head',
  'hearing', 'hill', 'hope', 'horse', 'hotel', 'household',
  'housing', 'impact', 'importance', 'incident', 'income', 'increase',
  'independence', 'individual', 'industry', 'influence', 'information',
  'injury', 'input', 'instance', 'institution', 'insurance', 'interest',
  'interview', 'introduction', 'investigation', 'investment', 'island',
  'item', 'king', 'knowledge', 'lack', 'lady', 'land', 'leader',
  'league', 'leg', 'length', 'lesson', 'letter', 'level', 'lie',
  'lift', 'limit', 'link', 'list', 'lord', 'loss', 'lot', 'love',
  'machine', 'magazine', 'manager', 'manner', 'mark', 'market',
  'mass', 'meaning', 'measure', 'media', 'meeting', 'member',
  'memory', 'method', 'middle', 'mind', 'minister', 'miss', 'mistake',
  'model', 'moment', 'mouth', 'movement', 'murder', 'name', 'nature',
  'neck', 'network', 'news', 'newspaper', 'nobody', 'notion',
  'object', 'offer', 'operation', 'opinion', 'opportunity', 'option',
  'output', 'owner', 'page', 'pain', 'paper', 'part', 'partner',
  'party', 'passage', 'patient', 'payment', 'pension', 'percentage',
  'performance', 'period', 'permission', 'piece', 'plane', 'player',
  'pleasure', 'pocket', 'policy', 'politics', 'pool', 'position',
  'post', 'pound', 'practice', 'press', 'price', 'principle',
  'prison', 'process', 'product', 'professor', 'profit', 'programme',
  'program', 'progress', 'project', 'promise', 'proportion', 'proposal',
  'protection', 'provision', 'purpose', 'quarter', 'queen', 'question',
  'range', 'rate', 'reader', 'reality', 'reason', 'record', 'reduction',
  'reference', 'reform', 'region', 'relationship', 'release', 'relief',
  'reply', 'report', 'request', 'research', 'resource', 'response',
  'responsibility', 'rest', 'result', 'return', 'revenue', 'review',
  'revolution', 'ring', 'risk', 'river', 'role', 'room', 'route',
  'row', 'rule', 'safety', 'sale', 'scale', 'scene', 'scheme',
  'secretary', 'security', 'sense', 'series', 'shape', 'share',
  'shoulder', 'sight', 'sign', 'silence', 'site', 'situation',
  'skill', 'smile', 'society', 'software', 'sort', 'source', 'space',
  'spirit', 'spot', 'spread', 'staff', 'stage', 'stand', 'standard',
  'statement', 'station', 'status', 'step', 'stock', 'strategy',
  'strength', 'strike', 'stuff', 'style', 'success', 'supply',
  'surface', 'surprise', 'survey', 'system', 'target', 'task',
  'tax', 'technique', 'technology', 'telephone', 'theory', 'threat',
  'title', 'tool', 'top', 'total', 'touch', 'tour', 'trade',
  'traffic', 'travel', 'trouble', 'truth', 'turn', 'type',
  'understanding', 'union', 'user', 'version', 'victim', 'view',
  'volume', 'vote', 'wage', 'wall', 'waste', 'wave',
  'weight', 'welfare', 'whole', 'wing', 'worry', 'worth', 'youth',

  // Common adjectives missing from original list
  'actual', 'additional', 'afraid', 'alone', 'amazing', 'annual',
  'appropriate', 'aware', 'basic', 'blue', 'brief', 'broad', 'broader',
  'brown', 'careful', 'central', 'cheap', 'chief', 'civil', 'close',
  'cold', 'commercial', 'concerned', 'considerable', 'critical',
  'cultural', 'deep', 'democratic', 'different', 'direct', 'effective',
  'effective', 'entire', 'environmental', 'equal', 'equally', 'essential',
  'European', 'exact', 'exactly', 'excellent', 'existing', 'extra',
  'extreme', 'familiar', 'famous', 'far', 'federal', 'final',
  'financial', 'fine', 'flat', 'following', 'foreign', 'formal',
  'former', 'free', 'fresh', 'front', 'full', 'funny', 'further',
  'general', 'global', 'grand', 'green', 'grey', 'growing',
  'guilty', 'huge', 'human', 'immediate', 'important', 'independent',
  'initial', 'inner', 'internal', 'international', 'joint', 'key',
  'large', 'late', 'latest', 'leading', 'left', 'legal', 'less',
  'likely', 'living', 'local', 'lone', 'loose', 'lost', 'lovely',
  'lucky', 'main', 'major', 'married', 'mass', 'medical',
  'mental', 'merely', 'military', 'minor', 'modern', 'narrow',
  'national', 'necessary', 'negative', 'neither', 'nervous', 'nice',
  'normal', 'northern', 'obvious', 'official', 'okay', 'online',
  'opposite', 'original', 'otherwise', 'overall', 'particular',
  'personal', 'physical', 'plain', 'pleasant', 'plenty', 'plus',
  'political', 'popular', 'positive', 'potential', 'powerful',
  'primary', 'proper', 'proud', 'pure', 'quick', 'quiet',
  'rare', 'raw', 'ready', 'real', 'recent', 'red', 'remaining',
  'remarkable', 'responsible', 'rough', 'royal', 'rural', 'sad',
  'secret', 'senior', 'separate', 'serious', 'severe', 'sharp',
  'significant', 'similar', 'single', 'slight', 'smart', 'social',
  'solid', 'sorry', 'southern', 'spare', 'special', 'specific',
  'standard', 'strange', 'strict', 'substantial', 'successful',
  'sudden', 'sufficient', 'suitable', 'super', 'sure', 'sweet',
  'terrible', 'thick', 'tight', 'tightly', 'tiny', 'top', 'tough',
  'traditional', 'typical', 'ugly', 'unable', 'unique', 'unlikely',
  'upper', 'urban', 'usual', 'vast', 'vital', 'warm', 'weekly',
  'western', 'white', 'wild', 'willing', 'wonderful', 'wooden',

  // Common adverbs and connectors
  'above', 'abroad', 'according', 'accordingly', 'across', 'ahead',
  'along', 'already', 'altogether', 'anyway', 'anywhere', 'apart',
  'apparently', 'aside', 'barely', 'behind', 'below', 'beneath',
  'beside', 'besides', 'beyond', 'closely', 'completely', 'deeply',
  'directly', 'elsewhere', 'entirely', 'eventually', 'everywhere',
  'extra', 'fairly', 'finally', 'firmly', 'formerly', 'forward',
  'gradually', 'hardly', 'heavily', 'hence', 'highly', 'honestly',
  'hopefully', 'immediately', 'increasingly', 'indeed', 'instead',
  'largely', 'lately', 'later', 'least', 'lightly', 'likewise',
  'mainly', 'meanwhile', 'merely', 'moreover', 'mostly', 'naturally',
  'nearby', 'nearly', 'nevertheless', 'nonetheless', 'normally',
  'nowhere', 'obviously', 'otherwise', 'overall', 'partly', 'perfectly',
  'perhaps', 'personally', 'possibly', 'precisely', 'previously',
  'primarily', 'properly', 'purely', 'quickly', 'quietly', 'rapidly',
  'recently', 'relatively', 'roughly', 'seriously', 'sharply',
  'significantly', 'simply', 'slightly', 'slowly', 'somehow',
  'somewhat', 'somewhere', 'specifically', 'strongly', 'surely',
  'therefore', 'thoroughly', 'thus', 'tonight', 'totally',
  'towards', 'typically', 'ultimately', 'unfortunately', 'unlike',
  'virtually', 'whatever', 'whenever', 'whereas', 'wherever',
  'widely', 'within', 'without', 'yeah', 'yet',

  // Common time words
  'daily', 'monthly', 'yearly', 'annual', 'tonight', 'weekend',
  'december', 'january', 'february', 'march', 'april', 'may', 'june',
  'july', 'august', 'september', 'october', 'november',
  'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday',

  // Common tech/business vocabulary
  'app', 'apps', 'blog', 'bot', 'bots', 'browser', 'coding',
  'computer', 'computers', 'cyber', 'desktop', 'digital', 'download',
  'email', 'file', 'files', 'folder', 'hardware', 'inbox',
  'internet', 'laptop', 'login', 'mobile', 'online', 'password',
  'phone', 'platform', 'printer', 'screen', 'search', 'server',
  'site', 'software', 'spam', 'tab', 'upload', 'url', 'user',
  'users', 'web', 'website', 'wifi',
  'budget', 'brand', 'corporate', 'customer', 'employee', 'firm',
  'hire', 'hired', 'hiring', 'invest', 'investor', 'loan',
  'marketing', 'office', 'profit', 'revenue', 'salary', 'startup',
  'stock', 'tax', 'wage',

  // Contraction fragments (from tokenizer splitting didn't, wasn't, etc.)
  'didn', 'doesn', 'isn', 'wasn', 'weren', 'hasn', 'haven',
  'wouldn', 'couldn', 'shouldn', 'aren', 'ain', 'won', 'll', 've', 're',
]);
